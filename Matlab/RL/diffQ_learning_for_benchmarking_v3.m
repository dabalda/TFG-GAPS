function [ PI_diff, Q_diff, v_diff, episodes_count, n_samples, G ] = diffQ_learning_for_benchmarking_v3( problems, n_episodes, epsilon, alpha, discount_threshold, tolerance, verbose, stability_threshold, min_stable_steps, neighbours )
%DIFFQ_LEARNING_for_benchmarking_v3
